...
def create():
    ...
    s = ("инженер ", "химик ", "строитель", "музыкант", "программист", "поп", "врач", "пожарный", "полицейский",
         "МЧСник", "уборщик", "официант", "администратор", "инкассатор", "учитель", "водитель", "космонавт", "электрик",
         "ювелир", "артист", "продавец", "инвестор")
    z = ("у вас Рахит", "у вас синдром Хрустального человека ", "у вас Булимия", "у вас Шизофрения",
