...
"""
bot - переменная, которая хранит в себе 'тело' бота.
ADMINROLES - переменная, которая хранит в себе админскую роль. В данный момент ей является роль 'Админ'.
users_bunker - список, который хранит в себе ники игроков, которые зарегестрировались на игру в бункер. Получает значения из функции join_bunker.
users_mafia - список, который хранит в себе ники игроков, которые зарегестрировались на игру в бункер. Получает значения из функции join_mafia.
roles - список, который хранит в себе роли для игры в мафию. Обновляется функциями roles_add, roles_clear, roles_del"""
